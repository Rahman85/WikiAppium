...
public class MainPageObjects {
    ...
    {
        WebElement element = waitForElementPresent(locator, error_message, 25);
        element.click();
        return element;
    }
    ...
    public void clickElementTheRightUpperCorner(String locator, String error_message) {
        if (driver instanceof AppiumDriver) {
            WebElement element = this.waitForElementPresent(locator + "/..", error_message);
            ...
            System.out.println("Method clickElementTheRightUpperCorner() does nothing for Platform " + Platform.getInstance().getPlatformVar());
        }
    }

    public void swipeElementToLeft(String locator, String error_message, long timeoutInSeconds) {
        if (driver instanceof AppiumDriver) {
            WebElement element = waitForElementPresent(locator, error_message, 30);
