...
public class AuthorizationPageObject extends MainPageObjects
{
    ...
    public void enterLoginData(String login, String password)
    {
        ...
        this.waitForElementAndSendKeys(PASSWORD_INPUT, password, "Cannot find and put a login to the login input", 10 );
    }
